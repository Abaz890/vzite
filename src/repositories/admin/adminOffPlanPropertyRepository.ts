...
export default class adminOffPlanPropertyRepository {
  ...
  public static async getProperty(id: string, source = "") {
    let url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${id}`;
    if (source.length > 0) {
  ...
  public static async updateProperty(referenceId: string, data: any) {
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${referenceId}`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
  ...
  public static async updatePropertyStatus(referenceId: string) {
    ...
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${referenceId}/update_status`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
  ...
  public static async orderPropertyMedia(referenceId: string, sorting: string[]) {

    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${referenceId}/media/order`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
  ...
  public static async getPaymentPlans(property_id: string) {
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${property_id}/payment_plans`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
    const response = await axios.get(url,
      {
        headers: {
  ...
  public static async addPaymentPlan(property_id: string, data: any) {
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${property_id}/payment_plans`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
    const response = await axios.post(url, data, {
      headers: {
  ...
  public static async updatePaymentPlan(property_id: string, unit_id: string, data: any) {
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${property_id}/payment_plans/${unit_id}`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
    const response = await axios.put(url, data, {
      headers: {
        Authorization: authToken,
  ...
  public static async deletePaymentPlan(property_id: string, payment_plan_id: string) {
    const url = import.meta.env.VITE_PROPERTIES_APP_BASE_URL + `/properties/offplan/${property_id}/payment_plans/${payment_plan_id}`;
    const authToken = `Bearer ${Cookies.get("props_token")}`;
    const response = await axios.delete(url, {
      headers: {
        Authorization: authToken,
