...
export default function MediaStep({ form, media }: { form: UseFormReturn<any>; media: any }) {
  ...
  const handleFileSortUpdated = async (sorting: string[]) => {
    const reference_id = form.getValues("reference_id");
    await adminOffPlanPropertyRepository.orderPropertyMedia(reference_id, sorting)
  }
