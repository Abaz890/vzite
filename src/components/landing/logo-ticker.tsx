...
// SVG brand icons
const FbIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4.5 h-4.5 text-blue-600">
...
const IgIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4.5 h-4.5 text-pink-500">
...
const TkIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4.5 h-4.5 text-slate-700">
...
const platforms = [
  { iconComp: () => <Search className="w-4.5 h-4.5 text-red-500" />, label: "Property Finder" },
  { iconComp: () => <Home className="w-4.5 h-4.5 text-orange-500" />, label: "Bayut" },
  { iconComp: () => <Building2 className="w-4.5 h-4.5 text-green-500" />, label: "Dubizzle" },
  { iconComp: FbIcon, label: "Facebook" },
  { iconComp: IgIcon, label: "Instagram" },
  { iconComp: () => <Target className="w-4.5 h-4.5 text-blue-500" />, label: "Meta Ads" },
  { iconComp: TkIcon, label: "TikTok" },
  { iconComp: () => <Zap className="w-4.5 h-4.5 text-orange-400" />, label: "Zapier" },
]
...
function TickerItem({
  ...
  return (
    <div className="inline-flex items-center gap-3 mx-8 opacity-40 hover:opacity-100 transition-opacity duration-300 cursor-default group">
      <div className="w-9 h-9 rounded-xl bg-slate-50 group-hover:bg-slate-100 flex items-center justify-center transition-colors border border-slate-100">
        <Icon />
      </div>
