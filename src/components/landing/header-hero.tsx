...
import { ChevronDown, ChevronRight, Users, Hop as Home, Building2, MapPin, Calendar, Database, GitBranch, TrendingUp, Settings, SlidersHorizontal, RotateCcw, Briefcase, Megaphone, Shield, DollarSign, Monitor, Search, Globe, Phone, Mail, BookOpen, Headphones, Zap, AtSign, Menu, X, ArrowRight, Video, MessageSquare, RadioTower, Layers, Star, FileText, UserCheck, Target } from "lucide-react"
            ...
            <div className="mx-auto max-w-7xl">
              <div className="bg-white rounded-2xl shadow-2xl shadow-black/10 border border-slate-100 overflow-hidden">
                ...
                {openMenu === "features" && (
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Platform Features</p>
                      <Link
                        to="/features"
                ...
                {openMenu === "solutions" && (
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Built For Every Team</p>
                      <Link
                        to="/solutions"
                        onClick={() => setOpenMenu(null)}
                        className="text-xs font-semibold text-teal-600 hover:text-teal-700 transition-colors"
                ...
                {openMenu === "integrations" && (
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Connected Platforms</p>
                      <Link
                        to="/integrations"
                        onClick={() => setOpenMenu(null)}
                        className="text-xs font-semibold text-teal-600 hover:text-teal-700 transition-colors"
  ...
  return (
    ...
    >
      <div className="w-7 h-7 rounded-lg bg-slate-100 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-slate-200 transition-colors">
        <Icon className={cn("w-3.5 h-3.5", item.color || "text-slate-600")} />
      </div>
      <div>
